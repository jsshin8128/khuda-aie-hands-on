...
## 5. 이벤트 루프의 기반이 되는 epoll (kqueue / IOCP)
...
동작 원리는 같습니다. asyncio는 실행 환경에 따라 자동으로 맞는 것을 씁니다. 이 가이드에서는 Linux 기준인 epoll로 설명합니다.
